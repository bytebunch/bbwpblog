...
if(isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] >= 1 && isset($_GET['vkey'])){
	...
	if($user){
		...
		if($db_key && $verify_key === md5($db_key)){
			...
			$message = 'This url has been expired.';
	}
}
					...
					<?php if (have_posts()): while (have_posts()) : the_post(); ?>
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
								<form action="<?php the_permalink(); ?>" class="jquery_validated_form" method="post">
									...
									<p><a href="<?php echo get_permalink($BBBThemeOptions->get_option('page_forgot_password_id')); ?>">Forgot your password?</a></p>
								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										...
										<p><a href="<?php echo get_permalink($BBBThemeOptions->get_option('page_terms_of_use_id')); ?>">Terms of use</a> | <a href="<?php echo get_permalink($BBBThemeOptions->get_option('page_privacy_policy_id')); ?>">Privacy policy</a></p>
										<p><a class="orange_btn" href="<?php echo get_permalink($BBBThemeOptions->get_option('page_register_id')); ?>">Create My Account</a></p>
								</div>
